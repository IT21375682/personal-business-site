      ...
      <Collapse open={open}>
        <div className="container mx-auto mt-4 rounded-lg bg-white px-6 py-5 shadow-lg lg:hidden">
          ...
          <div className="mt-6 flex items-center gap-3">
            <IconButton variant="text" color="gray" size="sm" aria-label="LinkedIn" as="a" href="https://www.linkedin.com/in/shantha-jayasena-73950359/" target="_blank">
              <i className="fa-brands fa-linkedin text-base" />
            </IconButton>
            <IconButton variant="text" color="gray" size="sm" aria-label="WhatsApp" as="a" href="https://wa.me/97xxxxxxxxx" target="_blank">
              <i className="fa-brands fa-whatsapp text-base" />
            </IconButton>
            <Button color="blue" size="sm" className="ml-auto" as="a" href="#book-call">
              Book a Call
            </Button>
          </div>
        </div>
